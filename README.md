...
本授权系统的开发调试过程均以[go-cqhttp](https://github.com/Mrs4s/go-cqhttp)进行, 请使用v0.9.24-fix2以上版本的[go-cqhttp](https://github.com/Mrs4s/go-cqhttp); 不支持v1.0.0以上版本的[go-cqhttp](https://github.com/Mrs4s/go-cqhttp). 
